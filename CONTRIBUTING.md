...
If you're using this repo to actually study, fork it and check off resources as you complete them (the resource lists use GitHub's task-list checkboxes) — your fork becomes a personal progress tracker, and it's a nice way to see how far you've come.
